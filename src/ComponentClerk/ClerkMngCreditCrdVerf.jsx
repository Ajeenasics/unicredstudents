...
function ClerkMngCreditCrdVerf() {
    return (
        <>
            <div className='clerk-mng-style'>
                ...
                <div className='mng-clerk-header'>
                    <br></br>
                    <span id='mng-clerk-head1' className='mng-clerk-head'>MANAGE</span> <span id='mng-clerk-head2' className='mng-clerk-head'>CREDIT CARD</span><br></br>
                    <center>
                        ...
                        <Table border={3} className='mng-clerk-table'>
                            <thead >
                                <tr>
                                    ...
                                    <th id='mng-clerk-tableh'>Card type</th>
                                    <th id='mng-clerk-tableh'>Credit Card Limit</th>
...
export default ClerkMngCreditCrdVerf