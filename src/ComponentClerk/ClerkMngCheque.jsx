    ...
    return (
        ...
        <div className='clerk-mng-style'>
            ...
            <br></br>
                ...
                <center>
                    <button id='mng-clerk-btn1' className='mng-clerk-btn'>Cheque request</button>
                    <button id='mng-clerk-btn2' className='mng-clerk-btn'>Verified Cheque</button>
                </center>
            </div>
            <br></br><br></br>
